...
window.__api={figEdit,feSelect,feTranslate,fePush,feCommit,feGroup,feUngroup,feUnnest,feDel,feResolve,feHtml,
  ...
  srcHtml,srcSync,feId,edgePoint,figChrome,layName,LAY,LAYS,layOf,areaGroups,areasHtml,soloFig,figAR,tidyDeck,get feDraw(){return feDraw},set feDraw(v){feDraw=v},
