...
window.__api={figEdit,feSelect,feTranslate,fePush,feCommit,feGroup,feUngroup,feUnnest,feDel,feResolve,feHtml,
  ...
  fitProbe,fitOver,fitDecided,fitSlidePlan,fitDeckLost,fitDeckWizard,FIT_SAYS,fitRuns,fitOrdered,
  ...
  copySlides,cutSlides,pasteSlides,mergeFigs,figsOf,picked,PICKED,slideStyle,sstyle,styleVars,queueEdit,editSlide,splitTrailer,figTrailer,bindIdeas,pasteKey,clipRead,clipWrite,closeDialog,
