...
window.__api={figEdit,feSelect,feTranslate,fePush,feCommit,feGroup,feUngroup,feUnnest,feDel,feResolve,feHtml,
  ...
  parseStyle,STYLE_KEYS,normalise,slideMd,style,slideMenu,newDeck,renameDeck,unbanner,useLoad,useNote,useReset,usageHtml,
  KIND_LABEL,nfmt,safeUrl,askReplace,writeServer,aiSays,disarmSvg,scopeSvg,put,get,cfgUrl,DEMO_AI,DEMO_HOSTS,demoLimitsHtml,llmOnce,transient,RETRY,swipes,step};"""
ready = """
